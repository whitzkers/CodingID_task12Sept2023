...
WebUI.setText(findTestObject('Object Repository/Page_Masuk untuk dapatkan akses di Coding.ID/input_Email_email'), GlobalVariable.unregistEmail)

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Masuk untuk dapatkan akses di Coding.ID/input_Kata                                 _98da12'), 
    GlobalVariable.unregistPassword)

WebUI.click(findTestObject('Object Repository/Page_Masuk untuk dapatkan akses di Coding.ID/button_Login'))

WebUI.verifyElementPresent(findTestObject('Page_Masuk untuk dapatkan akses di Coding.ID/span_Email harus terverifikasi'), 
    0)

WebUI.click(findTestObject('Page_Masuk untuk dapatkan akses di Coding.ID/button_Verifikasi'))

WebUI.verifyElementPresent(findTestObject('verifPage/txt_Verifikasi Email'), 0)
