...
WebUI.setText(findTestObject('Object Repository/Page_Masuk untuk dapatkan akses di Coding.ID/input_Email_email'), GlobalVariable.invalEmail)
...
WebUI.verifyElementPresent(findTestObject('Page_Masuk untuk dapatkan akses di Coding.ID/txt_Email atau kata sandi salah'), 
    0)
