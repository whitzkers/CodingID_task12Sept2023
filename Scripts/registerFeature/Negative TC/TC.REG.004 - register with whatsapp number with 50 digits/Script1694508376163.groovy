...
WebUI.setText(findTestObject('registerPage/input_Whatsapp_whatsapp'), GlobalVariable.invalWhatsapp)
...
WebUI.verifyElementText(findTestObject('verifPage/txt_Verifikasi Email'), 'Verifikasi Email')
