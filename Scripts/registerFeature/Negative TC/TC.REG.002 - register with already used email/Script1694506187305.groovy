...
WebUI.setText(findTestObject('registerPage/input_E-Mail_email'), GlobalVariable.registEmail)
...
WebUI.verifyElementText(findTestObject('registerPage/txt_Email sudah  terdaftar'), 'Email sudah terdaftar.')
